...
import { useGetAllCategoryQuery, useRemoveCategoryMutation } from '../../../app/api/categoryApiSlice';
...
const CategoryAdmin = () => {  
    ...
    const {data: categoryList, loading: categoryLoading, error: categoryError} = useGetAllCategoryQuery();
