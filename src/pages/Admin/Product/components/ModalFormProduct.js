  ...
  const onFinish = (values) => {
    ...
    switch (mode) {
      case MODE.ADD:
        ...
        break;
      case MODE.EDIT:
        console.log("old ingredient >>>>>>", arrIngredient);
        console.log("current ingredient >>", values.ingredientObjArr);
        console.log("real ingredient >>>>>");
        // console.log({...info, typeObjArr, imageObjArr, ingredientObjArr: arrIngredient})
    ...
    <>
      ...
      >
        <Form
          ...
          layout="vertical"
        >
          <Form.Item className="tw-hidden" name="id">
            <Input />
          </Form.Item>

          <Form.Item className="tw-hidden" name="idUnit">
            <Input />
          </Form.Item>
          ...
          <div className="tw-mx-6 tw-mt-3">
            <h3 className="tw-border-b-2 tw-pb-2 tw-mb-4">
                      ...
                      >
                        <Form.Item
                          ...
                          shouldUpdate={(prevValues, curValues) =>
                            prevValues.ingredientObjArr !==
                            curValues.ingredientObjArr
                          }
                        >
                          {() => (
                            <Form.Item
                            ...
                            >
                              <Select
                                className="tw-w-full lg:tw-min-w-[250px] sm:tw-min-w-[175px]"
